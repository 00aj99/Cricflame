...
import com.cricflame.cricflame.BrowseScorecardActivity;
...
public class Browse_Scoreboard_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        team1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                team_score="1";
                startActivity(new Intent(getActivity(), BrowseScorecardActivity.class));
