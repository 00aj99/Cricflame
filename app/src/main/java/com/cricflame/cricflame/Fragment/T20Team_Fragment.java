...
public class T20Team_Fragment extends Fragment {
    ...
    public void getAllInternationalTours(){
        tourData.clear();
        JsonObjectRequest jsonObjectRequest=new JsonObjectRequest(Request.Method.GET, Global.URL+"team.php?type=T20", null, new Response.Listener<JSONObject>() {
            @Override
