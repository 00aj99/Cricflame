...
import static com.cricflame.cricflame.BrowsePlayer.Player_Id;

/**
 * Created by Deepak Sharma on 29/10/2017.
 */

public class Player_Batting  extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.player_batting_layout, container, false);
        batting_list = (ListView) view.findViewById(R.id.listView1);
    ...
    public void getPlayerBattingData(){
        battingList.clear();
        JsonObjectRequest productRequest = new JsonObjectRequest(Request.Method.GET, Global.URL + "player.php?id="+Player_Id, null, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject jsonObject) {
                try {
                    ...
                    JSONArray data = result.getJSONArray("batting_info");
                    if (data.length()<=0) {
                        ...
                        for (int i = 0; i < data.length(); i++) {
                            ...
                            score.setBatsman(runs.getString("batting"));
                            score.setBat_run(runs.getString("test"));
                            score.setBat_ball(runs.getString("odi"));
                            score.setFour(runs.getString("t20"));
                            score.setSix(runs.getString("ipl"));
    ...
    public class Batting_adapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null)
                convertView = inflater.inflate(R.layout.player_batting_view, null);


            TextView batsman = (TextView) convertView.findViewById(R.id.batting);
            TextView run = (TextView) convertView.findViewById(R.id.test);
            TextView bowl = (TextView) convertView.findViewById(R.id.odi);
            TextView four = (TextView) convertView.findViewById(R.id.t20);
            TextView six = (TextView) convertView.findViewById(R.id.ipl);
