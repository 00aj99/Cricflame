...
public class Team1LiveScore extends Fragment {
    ...
    private final Runnable m_Runnable = new Runnable()
    {
...

        {
            ...
            Team1LiveScore.this.mHandler.postDelayed(m_Runnable, 5000);
        }
    ...
    public void getTeam1ScoreBoard(){
        ...
        JsonObjectRequest jsonObjectRequest=new JsonObjectRequest(Request.Method.GET, Global.URL+"liveline_scorecard.php", null, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                try {
                    ...
                    if (teams.getString("match_type").equals("TEST")) {
                        String inning= LiveLineScoreboard.team_score_live;
                        if (inning.equals("1")){
                    ...
                    total.setText(team1score.getString("total"));
