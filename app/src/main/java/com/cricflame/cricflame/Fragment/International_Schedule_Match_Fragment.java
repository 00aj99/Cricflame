...
public class International_Schedule_Match_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        SeriesWise.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                seriesWise_adapter = new SeriesWise_Adapter(getActivity(), SeriesData,"INTERNATIONAL");
                tour_list.setHasFixedSize(true);
                final LinearLayoutManager mLayoutManager = new LinearLayoutManager(getActivity(),LinearLayoutManager.VERTICAL, false);
                //tour_list.setLayoutManager(new LinearLayoutManager(getActivity(), LinearLayoutManager.VERTICAL, false));
                tour_list.setLayoutManager(mLayoutManager);
        ...
        TeamWise.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ClickType="TeamWise";
                teamWiseAdapter = new TeamWiseAdapter(getActivity(),teamNames,"INTERNATIONAL");
                ...
                if(teamNames.size()==0){
                    teamNames.clear();
                    currentItem = 0;
                    new GetAllInternationalTeam().execute();
                }
            }
        });
    ...
    public void getAllInternationalTours(){
        ...
        loadingDialog.show();
        checkScrolling =0;
        childref = mRootref.child("Fixtures").child("INTERNATIONAL").child("DATEWISE");
        childref.orderByKey()
    ...
    public void getAllSereisWiseMatch(){
        ...
        loadingDialog.show();
        checkScrolling =0;
        childref = mRootref.child("Fixtures").child("INTERNATIONAL").child("SERIEWISE");
        childref.orderByKey()
                .startAt(String.valueOf(currentItem))
                .limitToFirst(mPostsPerPage)
    ...
    public class GetAllInternationalTeam extends AsyncTask<String,Void,String> {
