...
public class International_Match_Fragment extends Fragment {
    ...
    public void getAllInternationalTours() {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, URL + "league.php?status=series", null, new Response.Listener<JSONObject>() {
            @Override
