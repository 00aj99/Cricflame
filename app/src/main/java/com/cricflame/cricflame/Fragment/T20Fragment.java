...
public class T20Fragment extends Fragment {
    ...
    public void getTeamT20Ranking(){
        loadingDialog.show();
        childref = mRootref.child("IccRanking").child(ConvertGender).child("Team").child("Secondoryscreen").child("T20");
    ...
    public void getPlayerT20Ranking(){
        loadingDialog.show();
        childref = mRootref.child("IccRanking").child(ConvertGender).child("Players").child("Secondoryscreen").child("T20").child("BATSMAN");
        childref.orderByKey()
    ...
    public void getPlayerAllrounderT20Ranking(){
        loadingDialog.show();
        childref = mRootref.child("IccRanking").child(ConvertGender).child("Players").child("Secondoryscreen").child("T20").child("ALLROUNDER");
        childref.orderByKey()
                .startAt(String.valueOf(currentItem))
                .limitToFirst(mPostsPerPage)
                .addListenerForSingleValueEvent(new ValueEventListener() {
    ...
    public void getPlayerBowlerT20Ranking(){
        loadingDialog.show();
        childref = mRootref.child("IccRanking").child(ConvertGender).child("Players").child("Secondoryscreen").child("T20").child("BOWLER");
        childref.orderByKey()
                .startAt(String.valueOf(currentItem))
                .limitToFirst(mPostsPerPage)
                .addListenerForSingleValueEvent(new ValueEventListener() {
