...
public class BTeam1Scoreboard_Fragment extends Fragment {
...
//    };
    ...
    public void getTeam1ScoreBoard(){
        ...
        JsonObjectRequest jsonObjectRequest=new JsonObjectRequest(Request.Method.GET, Global.URL+"match_info.php?id="+ All_Matches_Fragment.BMatchId, null, new Response.Listener<JSONObject>() {
            @Override
