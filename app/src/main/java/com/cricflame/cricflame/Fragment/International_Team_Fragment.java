...
public class International_Team_Fragment extends Fragment {
    ...
    public void getAllInternationalTours(){
        tourData.clear();
        JsonObjectRequest jsonObjectRequest=new JsonObjectRequest(Request.Method.GET, URL+"team.php?type=International", null, new Response.Listener<JSONObject>() {
            @Override
