...
public class T20_Schedule_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        SeriesWise.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                seriesWise_adapter = new SeriesWise_Adapter(getActivity(), SeriesData,"T20");
                tour_list.setHasFixedSize(true);
                final LinearLayoutManager mLayoutManager = new LinearLayoutManager(getActivity(),LinearLayoutManager.VERTICAL, false);
                //tour_list.setLayoutManager(new LinearLayoutManager(getActivity(), LinearLayoutManager.VERTICAL, false));
                tour_list.setLayoutManager(mLayoutManager);
        ...
        TeamWise.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ClickType="TeamWise";
                teamWiseAdapter = new TeamWiseAdapter(getActivity(),teamNames,"T20");
    ...
    public void getAllT20Matches(){
       // tourData.clear();
        try{
            loadingDialog.show();
            checkScrolling =0;
            childref = mRootref.child("Fixtures").child("T20").child("DATEWISE");
            childref.orderByKey()
    ...
    public void getAllSereisWiseMatch(){
        ...
        loadingDialog.show();
        checkScrolling =0;
        childref = mRootref.child("Fixtures").child("T20").child("SERIEWISE");
        childref.orderByKey()
                .startAt(String.valueOf(currentItem))
                .limitToFirst(mPostsPerPage)
    ...
    public class GetAllT20Teams extends AsyncTask<String,Void,String> {
