 ...
 */
public class BetfairFragment extends Fragment {
    ...
    public static String SportId="4";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_betfair, container, false);
        init(view);
        return view;
    }
    ...
    public class BetfairAdapter extends RecyclerView.Adapter<BetfairAdapter.MyViewHolder> {
        ...
        public void onBindViewHolder(final BetfairAdapter.MyViewHolder holder, int position) {
            ...
            try{
                holder.img.setImageDrawable(getActivity().getResources().getDrawable(R.drawable.cricket));
            }catch (Exception e){
                e.printStackTrace();
            }
