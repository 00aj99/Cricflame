 ...
 */
public class BetfairHorseFragment extends Fragment {
    ...
    public static String SportId="7";
    ...
    public class BetfairAdapter extends RecyclerView.Adapter<BetfairAdapter.MyViewHolder> {
        ...
        public void onBindViewHolder(final BetfairAdapter.MyViewHolder holder, int position) {
            ...
            try{
                holder.img.setImageDrawable(getActivity().getResources().getDrawable(R.drawable.horse_racing));
            }catch (Exception e){
                e.printStackTrace();
            }
