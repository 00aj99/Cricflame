...
public class Domestic_Team_Fragment extends Fragment {
    ...
    public void getAllInternationalTours(){
        tourData.clear();
        JsonObjectRequest jsonObjectRequest=new JsonObjectRequest(Request.Method.GET, Global.URL+"team.php?type=Domestic", null, new Response.Listener<JSONObject>() {
            @Override
