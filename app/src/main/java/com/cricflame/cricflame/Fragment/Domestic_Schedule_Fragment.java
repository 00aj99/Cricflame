...
public class Domestic_Schedule_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        SeriesWise.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                seriesWise_adapter = new SeriesWise_Adapter(getActivity(), SeriesData,"LEAGUE");
                tour_list.setHasFixedSize(true);
                final LinearLayoutManager mLayoutManager = new LinearLayoutManager(getActivity(),LinearLayoutManager.VERTICAL, false);
                //tour_list.setLayoutManager(new LinearLayoutManager(getActivity(), LinearLayoutManager.VERTICAL, false));
                tour_list.setLayoutManager(mLayoutManager);
        ...
        TeamWise.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ClickType="TeamWise";
                teamWiseAdapter = new TeamWiseAdapter(getActivity(),teamNames,"LEAGUE");
    ...
    public void getAllDomesticMatches(){
        try{

            loadingDialog.show();
            checkScrolling = 0;
            childref = mRootref.child("Fixtures").child("LEAGUE").child("DATEWISE");
            childref.orderByKey()
    ...
    public void getAllSereisWiseMatch(){
        ...
        try{
            ...
            loadingDialog.show();
            checkScrolling =0;
            childref = mRootref.child("Fixtures").child("LEAGUE").child("SERIEWISE");
            childref.orderByKey()
                    .startAt(String.valueOf(currentItem))
                    .limitToFirst(mPostsPerPage)
    ...
    public class GetAllLeagueTeams extends AsyncTask<String,Void,String> {
