...
public class AllTypeMatches_Fragment extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
                ...
                .setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
                    ...
                    public void onItemClicked(RecyclerView recyclerView, int position, View v) {
                     /*   tourAdapter_new= (TourAdapter_New) recyclerView.getAdapter();
                        ...
                        //Toast.makeText(getActivity(),"Match Unavailable",Toast.LENGTH_LONG).show();
                        //TastyToast.makeText(getActivity(), "Match Unavailable", TastyToast.LENGTH_LONG, TastyToast.WARNING);
        ...
        SeriesWise.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                seriesWise_adapter = new SeriesWise_Adapter(getActivity(), SeriesData,"ALL");
                tour_list.setHasFixedSize(true);
                final LinearLayoutManager mLayoutManager = new LinearLayoutManager(getActivity(),LinearLayoutManager.VERTICAL, false);
                //tour_list.setLayoutManager(new LinearLayoutManager(getActivity(), LinearLayoutManager.VERTICAL, false));
                tour_list.setLayoutManager(mLayoutManager);
        ...
        TeamWise.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ClickType="TeamWise";
                teamWiseAdapter = new TeamWiseAdapter(getActivity(),teamNames,"ALL");
    ...
    public void getAllMatches(){
        ...
        childref = mRootref.child("Fixtures").child("ALL").child("DATEWISE");
        childref.orderByKey()
    ...
    public void getAllSereisWiseMatch(){
        ...
        loadingDialog.show();
        checkScrolling =0;
        childref = mRootref.child("Fixtures").child("ALL").child("SERIEWISE");
        childref.orderByKey()
                .startAt(String.valueOf(currentItem))
                .limitToFirst(mPostsPerPage)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        try{
                            for(DataSnapshot snapshot:dataSnapshot.getChildren()){
                                //SeriesData.add(snapshot.getValue(SeriesWise_Model.class));
                                //seriesWise_adapter.notifyDataSetChanged();
