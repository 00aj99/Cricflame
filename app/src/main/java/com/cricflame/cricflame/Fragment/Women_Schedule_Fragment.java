...
public class Women_Schedule_Fragment extends Fragment {
...
*/
        ...
        SeriesWise.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                seriesWise_adapter = new SeriesWise_Adapter(getActivity(), SeriesData,"WOMEN");
                tour_list.setHasFixedSize(true);
                final LinearLayoutManager mLayoutManager = new LinearLayoutManager(getActivity(),LinearLayoutManager.VERTICAL, false);
                //tour_list.setLayoutManager(new LinearLayoutManager(getActivity(), LinearLayoutManager.VERTICAL, false));
                tour_list.setLayoutManager(mLayoutManager);
        ...
        TeamWise.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ClickType="TeamWise";
                teamWiseAdapter = new TeamWiseAdapter(getActivity(),teamNames,"WOMEN");
    ...
    public void getAllWomenMaches(){
        //tourData.clear();
        try{
            loadingDialog.show();
            checkScrolling = 0;
            childref = mRootref.child("Fixtures").child("WOMEN").child("DATEWISE");
            childref.orderByKey()
    ...
    public void getAllSereisWiseMatch(){
        ...
        loadingDialog.show();
        checkScrolling =0;
        childref = mRootref.child("Fixtures").child("WOMEN").child("SERIEWISE");
        childref.orderByKey()
                .startAt(String.valueOf(currentItem))
                .limitToFirst(mPostsPerPage)
    ...
    public class GetAllWomensTeams extends AsyncTask<String,Void,String> {
