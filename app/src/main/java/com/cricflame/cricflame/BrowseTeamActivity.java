...
import com.cricflame.cricflame.Model.TeamPager;


public class BrowseTeamActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(new CheckProxy().isProxyDisabled()){
            ...
            Toast.makeText(BrowseTeamActivity.this, "Something went wrong. Is proxy enabled?", Toast.LENGTH_SHORT).show();
            onBackPressed();
            finish();
        }
        ...
        tabLayout.addTab(tabLayout.newTab().setText("INTERNTIONAL"));
        ...
        TeamPager adapter = new TeamPager(getSupportFragmentManager(), tabLayout.getTabCount());
