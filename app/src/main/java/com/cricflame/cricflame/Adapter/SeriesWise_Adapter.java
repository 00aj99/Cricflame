...
public class SeriesWise_Adapter extends RecyclerView.Adapter<SeriesWise_Adapter.MyViewHolder> {
    public ArrayList<SeriesWise_Model> SereisList;
    Context context;
    String textAlready = "0";
    String FragmentInstance;

    public SeriesWise_Adapter(Context context, ArrayList<SeriesWise_Model> SereisList,String FragmentInstance){
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        try{
            ...
            if(SereisList.get(position).date_time.equalsIgnoreCase("hide Date")){
                ...
                holder.TimePeriod.setVisibility(8);
            }else{
                holder.TimePeriod.setVisibility(0);
                String date = null;
                String time = null;
