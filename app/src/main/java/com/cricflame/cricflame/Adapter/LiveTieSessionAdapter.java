...
public class LiveTieSessionAdapter extends RecyclerView.Adapter<LiveTieSessionAdapter.MyViewHolder> {
    Context context;
    List<Session_Model> SessionList;
    Session_Model session_model;

    public LiveTieSessionAdapter(Context context, List<Session_Model> SessionList){
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
       ...
       /* if(session_model.getLineLeft().contains(".")){
            ...
            String[] separated = session_model.getLineLeft().split("\\.");
            if(separated[0].startsWith("0") || separated[0].startsWith("1")){
                holder.LineLeft.setText(separated[1]);
            }else{
      ...
      //  }
        ...
        /*if(session_model.getLineRight().contains(".")){
            ...
            String[] separated = session_model.getLineRight().split("\\.");
            if(separated[0].startsWith("0") || separated[0].startsWith("1")){
                holder.LineRight.setText(separated[1]);
            }else{
                holder.LineRight.setText(session_model.getLineLeft());
            }
