package com.cricflame.cricflame.Ranking;
...
public class ICCRanking extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_iccranking);
        ...
        tabLayout.addTab(tabLayout.newTab().setText("BATSMAN"));
        tabLayout.addTab(tabLayout.newTab().setText("BOWLERS"));
        ...
        RankingPager adapter = new RankingPager(getSupportFragmentManager(), tabLayout.getTabCount());
