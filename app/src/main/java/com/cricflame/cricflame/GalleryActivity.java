...
import com.cricflame.cricflame.Model.GalleryPager;
...
public class GalleryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.cricflame.cricflame.R.layout.activity_gallery);
        ...
        GalleryPager adapter = new GalleryPager(getSupportFragmentManager(), tabLayout.getTabCount());
