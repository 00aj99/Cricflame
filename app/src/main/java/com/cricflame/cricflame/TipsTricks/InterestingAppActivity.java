...
public class InterestingAppActivity extends AppCompatActivity {
    ...
    public void OnClick(){
        ...
        if(new CheckProxy().isProxyDisabled()){
            ...
            Toast.makeText(InterestingAppActivity.this, "Something went wrong. Is proxy enabled?", Toast.LENGTH_SHORT).show();
            onBackPressed();
            finish();
        }
    }
    ...
    public void getTimePassData(){
        ...
        //progressDialog.show();
        JsonObjectRequest jsonArrayRequest=new JsonObjectRequest(Request.Method.GET, Global.URL+"interstingapp.php", null, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                ...
                adapter = new TipsAdapter(InterestingAppActivity.this, link);
                RecyclerView.LayoutManager mLayoutManager = new GridLayoutManager(InterestingAppActivity.this, 1);
        ...
        Volley.newRequestQueue(InterestingAppActivity.this).add(jsonArrayRequest);
    }
}
