...
public class AndroidTrickLinkActivity extends AppCompatActivity {
    private RecyclerView recyclerView;
    private TipsAdapter adapter;
    private ArrayList<TourData> link = new ArrayList<>();
    ...
    public void OnClick(){
        ...
        if(new CheckProxy().isProxyDisabled()){
            ...
            Toast.makeText(AndroidTrickLinkActivity.this, "Something went wrong. Is proxy enabled?", Toast.LENGTH_SHORT).show();
            onBackPressed();
            finish();
        }
    }
    ...
    public void getTimePassData(){
        ...
        //progressDialog.show();
        JsonObjectRequest jsonArrayRequest=new JsonObjectRequest(Request.Method.GET, Global.URL+"androidtricks.php", null, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                ...
                adapter = new TipsAdapter(AndroidTrickLinkActivity.this, link);
                RecyclerView.LayoutManager mLayoutManager = new GridLayoutManager(AndroidTrickLinkActivity.this, 1);
        ...
        Volley.newRequestQueue(AndroidTrickLinkActivity.this).add(jsonArrayRequest);
    }
}
