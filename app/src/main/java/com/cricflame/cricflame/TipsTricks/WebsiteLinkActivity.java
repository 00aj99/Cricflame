...
public class WebsiteLinkActivity extends AppCompatActivity {
    ...
    public void OnClick(){
        ...
        if(new CheckProxy().isProxyDisabled()){
            ...
            Toast.makeText(WebsiteLinkActivity.this, "Something went wrong. Is proxy enabled?", Toast.LENGTH_SHORT).show();
            onBackPressed();
            finish();
        }
    }
    ...
    public void getTimePassData(){
        ...
        //progressDialog.show();
        JsonObjectRequest jsonArrayRequest=new JsonObjectRequest(Request.Method.GET, Global.URL+"website_link.php", null, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                ...
                adapter = new TipsAdapter(WebsiteLinkActivity.this, link);
                RecyclerView.LayoutManager mLayoutManager = new GridLayoutManager(WebsiteLinkActivity.this, 1);
        ...
        Volley.newRequestQueue(WebsiteLinkActivity.this).add(jsonArrayRequest);
    }
}
