...
public class TippersLinkActivity extends AppCompatActivity {
    ...
    public void OnClick(){
        ...
        if(new CheckProxy().isProxyDisabled()){
            ...
            Toast.makeText(TippersLinkActivity.this, "Something went wrong. Is proxy enabled?", Toast.LENGTH_SHORT).show();
            onBackPressed();
            finish();
        }
    }
    ...
    public void getTimePassData(){
        ...
        //progressDialog.show();
        JsonObjectRequest jsonArrayRequest=new JsonObjectRequest(Request.Method.GET, Global.URL+"tippers_link.php", null, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                ...
                adapter = new TipsAdapter(TippersLinkActivity.this, link);
                RecyclerView.LayoutManager mLayoutManager = new GridLayoutManager(TippersLinkActivity.this, 1);
        ...
        Volley.newRequestQueue(TippersLinkActivity.this).add(jsonArrayRequest);
    }
}
